  ...
  return (
    <View style={[styles.hideCenterContent, centerContentStyle]}>
      ...
      {!isHideValue && (
        ...
        <Image source={icon1} style={{ height: moderateScale(16), width: moderateScale(16), marginRight: moderateScale(10) }} />
        <Image source={icon2} style={{ height: moderateScale(16), width: moderateScale(16), marginRight: moderateScale(10) }} />
        <Image source={icon3} style={{ height: moderateScale(16), width: moderateScale(16) }} />
        </View>
        </>
      )}
      {!isHideSubtitle && (
